...
if (typeof window !== 'undefined') {
  const registerGestureHandler = () => {
    // Check if AFRAME is available on the window object
    ...
    window.AFRAME.registerComponent('gesture-handler', {
      ...
      handleTouchStart: function (e) {
        ...
        // 1. Two Finger Touch: Initialize Pinch-to-Zoom
        ...
        // 2. Single Finger Touch: Initialize 360-degree Rotation
      ...
      handleTouchMove: function (e) {
        ...
        if (e.touches.length === 2 && this.initialDistance) {
          ...
          if (currentDistance > 0 && this.initialDistance > 0) {
            // Calculate scale ratio: d_current / d_initial
            const scaleFactor = currentDistance / this.initialDistance;
            
            // Compute new bounded scale
            ...
            // Apply new scale attribute to the 3D GLTF Model entity
            ...
            // Dispatch custom event for UI zoom feedback
